        ...
        <main className="pt-6 pb-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
              {/* Map Header */}
              <div className="bg-[#044BB1] px-6 py-4 flex items-center justify-between flex-wrap gap-3">
               
                    <div className="flex items-center gap-4 flex-1 min-w-[280px]">
                      <label htmlFor="dusun-select" className="text-white font-bold whitespace-nowrap text-sm uppercase tracking-wide bg-white/10 px-3 py-1 rounded-full border border-white/20">
                       Pilih Dusun:
                      </label>
                      <div className="relative flex-1 group">
                        <select
                          ...
                          className="w-full px-5 py-3 rounded-xl border-2 border-white/30 bg-gradient-to-r from-white/15 to-white/10 text-white font-semibold focus:outline-none focus:border-white/60 focus:ring-4 focus:ring-white/20 transition-all duration-300 cursor-pointer appearance-none shadow-lg hover:from-white/20 hover:to-white/15 hover:border-white/40 hover:shadow-xl backdrop-blur-sm"
                        >
