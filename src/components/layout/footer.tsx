          ...
          <div className="space-y-4 w-full">
            ...
            <div className="space-y-3 text-sm text-blue-100">
              <div className="flex items-start space-x-2">
                ...
                <span>
                  Desa Sriharjo, Kecamatan Imogiri, Kabupaten Bantul, DIY
                </span>
              </div>
            ...
            <div className="space-y-2 text-sm text-blue-100">
              {developers.map((dev, index) => (
                <div key={index} className="flex items-center space-x-2">
                  <div
                    className={`w-8 h-8 bg-gradient-to-br ${dev.color} rounded-full flex items-center justify-center text-white font-bold text-xs shadow-md`}
                  >
                    {dev.initial}
                  </div>
                  <div>
                    <p className="font-semibold text-white">{dev.name}</p>
                    <p className="text-xs text-blue-100">{dev.role}</p>
                  </div>
                </div>
              ))}
            </div>
